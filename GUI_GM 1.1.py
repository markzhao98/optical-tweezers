...
class GUI:
    ...
    def __init__(self, root, title):
        ...
        self.value_X = 0  # Equilibrium X voltage value at (856,1025)
        self.value_Y = -0.63  # Equilibrium Y voltage value at (856,1025)
        ...
        self.label_A = tk.Label(self.root, text = '(1055, 1025)', font='12', 
                                height = 2, width = 16, 
                                relief = tk.FLAT)
    ...
    def setbutton(self):
        ...
        if self.ifclick == True:
            ...
            self.value_X = - 0.02/8 * (self.X - 856)
            self.value_Y = - 0.03/16.25 * (self.Y - 1025) - 0.63
    ...
    def X_osci(self):
        ...
        self.amp = int(self.entry_amp.get()) * 0.02/8
    ...
    def Y_osci(self):
        ...
        self.amp = int(self.entry_amp.get()) * 0.03/16.25
